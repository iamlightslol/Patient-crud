...
<script src="<?php echo base_url();?>sximo/js/plugins/ajax/jquery.form.js"></script>
<script src="<?php echo base_url();?>sximo/js/plugins/ajax/noty/packaged/jquery.noty.packaged.min.js"></script>
<script src="<?php echo base_url();?>sximo/js/plugins/ajax/ajaxSximo.js"></script>

<link rel="stylesheet" href="<?php echo base_url();?>sximo/js/plugins/ajax/animate.css" type="text/css"  />
<link rel="stylesheet" href="<?php echo base_url();?>sximo/js/plugins/ajax/ajaxSximo.css" type="text/css"  />
...
<div class="modal fade " tabindex="-1" role="dialog" id="sximo-modal-lg"  aria-hidden="true">
