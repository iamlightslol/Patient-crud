...
<div class="container">
	<div class="row">
		<div class="col-md-7">
			<div class="overview">
				...
				<div class="button fadeInUp delayp2" >
					...
					<a href="" class="btn btn-success"><i class="fa fa-desktop"></i> Buy Codeigniter Sximo </a>
				</div>						
			</div>	
		</div>
		...
		<div class="col-md-5">
			<div class="laptop">
				<img src="<?php echo base_url().'sximo/themes/mango/img/dashboard2.png';?>" class="img-responsive" >
...
<div class="row">
        ...
        <div class="col-md-6 text-center">
			<img src="<?php echo base_url().'sximo/themes/mango/img/schema.png';?>" class="img-responsive" >
